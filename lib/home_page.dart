...
class _HomePageState extends State<HomePage> {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          if (data['status'] == 1) {
            ...
            ingredients = 'Fetching from Gemini AI...';
            nutritionalContent = 'Fetching from Gemini AI...';
  ...
  Future<void> fetchDetailsFromGemini(String productName) async {
    ...
    final prompt =
        "No extra Text Give the Exact Value Strictly What are the ingredients and the nutritional content Also Give in the Format of 2 Paragraphs one is Ingredients and other is Nutrional Facts per 100g dont change the line just change the line for the segregation(specifically providing a single value for each nutrient per 100 grams) of the following food product, keeping in mind it is from India: $productName, Give the Provided Things only Ingredients and Nutritional Information no extra information";
    ...
    try {
      ...
      print('Error fetching from Gemini AI: $e');
      setState(() {
        ingredients = 'Error fetching from Gemini AI';
        nutritionalContent = 'Error fetching from Gemini AI';
      });
    }
  }
